...
static void test_assert_str_equal_FAIL_null_null(void)
{
...
static void test_assert_str_not_equal_FAIL_expect_null(void)
{
	const char *a;
	a = "hoge";
...
static void test_assert_str_not_equal_FAIL_actual_null(void)
{
	const char *a;
	a = "hoge";
...
static void test_assert_nstr_equal_FAIL_null_null(void)
{
...
static void test_assert_nstr_not_equal_FAIL_expect_null(void)
{
	const char *a;
	a = "hogu";
...
static void test_assert_nstr_not_equal_FAIL_actual_null(void)
{
	const char *a;
	a = "hogu";
...
static PCU_Test tests[] = {
	...
	PCU_TEST(test_assert_str_equal_FAIL_null_null),
	PCU_TEST(test_assert_str_not_equal_OK),
	PCU_TEST(test_assert_str_not_equal_FAIL),
	PCU_TEST(test_assert_str_not_equal_MSG),
	PCU_TEST(test_assert_str_not_equal_FAIL_expect_null),
	PCU_TEST(test_assert_str_not_equal_FAIL_actual_null),
	...
	PCU_TEST(test_assert_nstr_equal_FAIL_null_null),
	PCU_TEST(test_assert_nstr_not_equal_OK),
	PCU_TEST(test_assert_nstr_not_equal_FAIL),
	PCU_TEST(test_assert_nstr_not_equal_MSG),
	PCU_TEST(test_assert_nstr_not_equal_FAIL_expect_null),
	PCU_TEST(test_assert_nstr_not_equal_FAIL_actual_null),
